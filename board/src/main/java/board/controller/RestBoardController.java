...
public class RestBoardController {
	...
	/*
	 * @RequestMapping(value="/board/file", method=RequestMethod.GET) public void
	 * downloadBoardFile(@RequestParam int idx, @RequestParam int boardIdx,
	 * HttpServletResponse response) throws Exception{ BoardFileDto boardFile =
